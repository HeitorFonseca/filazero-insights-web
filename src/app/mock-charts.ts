...
export const BARCHARTTESTDATA: ChartData[] = [
    {data: [], label: 'Tempo médio de espera',backgroundColor:'rgba(77,116,234,0.9)',
     borderColor: 'rgba(77,116,234,0.9)'},
    {data: [], label: 'Tempo médio de atendimento',backgroundColor:'rgba(225,10,24,0.9)',
...
export const CHARTPERFATDDATA: ChartData[] = [
    {data: [15], label: 'Tempo médio de espera',backgroundColor:'rgba(77,116,234,0.9)',
    borderColor: 'rgba(77,116,234,0.9)'},
    {data: [18], label: 'Tempo médio de atendimento',backgroundColor:'rgba(225,10,24,0.9)',
    borderColor: 'rgba(200,20,24,0.9)'}
];
...
export const CHARTDATAFEEDBACK: ChartData[] = [
    {data: [], label: 'Média mensal de avaliações',backgroundColor:'rgba(225,10,24,0.2)',
     borderColor: 'rgba(200,20,24,0.2)',yAxisID:'y-media',datalabels:{
        anchor: 'center',
        color: 'white',
        clamp: true
    }},
    {data: [], label: 'Total de avaliações',
    ...
    {data: [], label: 'Média geral',
     type:'line',fill:false, backgroundColor: 'rgba(77,116,234,0.7)',
     borderColor: 'rgba(77,110,240,0.2)', yAxisID:'y-media',datalabels:{
        anchor: 'start',
        clamp: true,
        align: 'end',   
        formatter: function(value, context){

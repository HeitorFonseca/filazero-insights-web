...
export const BARCHARTPERFTOTALDATA: ChartData[] = [
    {data: [], label: 'Tempo médio de espera',backgroundColor:'rgba(225,10,24,0.7)',
     borderColor: 'rgba(200,20,24,0.2)'},
    {data: [], label: 'Tempo médio de atendimento',backgroundColor:'rgba(77,116,234,0.7)',
...
export const CHARTDATAFEEDBACK: ChartData[] = [
    {data: [], label: 'Média mensal',backgroundColor:'rgba(225,10,24,0.2)',
...
export const BARCHARTTOPTIONSFEEDB = {
    ...
    title: {
        display: true,
        text: 'Classificação mensal x Classificação geral x Nº de avaliações',
        fontSize: 15
    },
    scales: {
        yAxes: [{
